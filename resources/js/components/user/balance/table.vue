<template>
    <div>
            ...
            <table class="table table-hover table-striped bg-white">
                <thead>
                    <tr>
                        ...
                        <th class="" width="150">Datum</th>
                        <th class="" width="33%">ID</th>
                        <th class="" width="33%">Buchungstext</th>
                        <th class="" width="33%">IBAN</th>
                        <th class="text-right" width="150">Umsatz</th>
                    </tr>
                </thead>
                <tbody>
        ...
        <div class="alert alert-dark mt-3" v-else><center>Keine Buchungen vorhanden</center></div>
            ...
            fetch() {
                ...
                axios.get(component.uri, {
                    ...
                    .catch(function (error) {
                        Vue.error('Buchungen konnten nicht geladen werden!');
                        console.log(error);
                    });
            },
            search() {
